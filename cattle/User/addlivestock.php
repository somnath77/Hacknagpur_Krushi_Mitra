...
<div class="container"> 
   ...
   <?php
      if(isset($_POST['action'])){
        ...
        $animals->insertOne( [ 'user_id'=>(string)$user_data['_id'],'livestock' =>$livestock,'breed'=>$breed,'use'=>$use,'gender'=>$gender,'DOB'=>new \MongoDB\BSON\UTCDateTime(strtotime($DOB) * 1000),'isAlive' => $alive,'approved' => null] );  
