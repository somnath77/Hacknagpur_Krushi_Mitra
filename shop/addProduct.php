    ...
    <body>      
            ...
            <div class="col m6 offset-m3 s12">
                <div class="row">
                     <div class="col s12">
      <ul class="tabs">
        <li class="tab col s3"><a href="#test1" class="active indigo-text ">Sell</a></li>
        <li class="tab col s3"><a href="#test2" class="indigo-text">Rent</a></li>        
      </ul>
    </div>
                </div>
            </div>
                ...
                <div class="input-field col s12 ">
                  <input placeholder="Placeholder" id="price" type="text" class="validate" name='price'>
                  <label for="first_name"> Price* </label>
                </div>  
                <div class="input-field col s12 ">
                  <input placeholder="Placeholder" id="details" type="text" class="validate" name='details'>
                  <label for="first_name"> Product Details* </label>
                </div> 
                <div class="input-field col s12 ">
                <p> Image </p>
                  <input placeholder="Placeholder" id="image" type="file" class="validate" name='image'>
                  <br>
                </div>     
                ...
                <p class="padleft10 remx" >
                <button  class="btn indigo " type="submit" name="action">Add</button>
                    </p>
                ...
                <div class="input-field col s12 ">
                  <input placeholder="Placeholder" id="first_name" type="text" class="validate" name='price'>
                  <label for="first_name"> Price* </label>
                </div>  
                <div class="input-field col s12 ">
                  <input placeholder="Placeholder" id="first_name" type="text" class="validate" name='details'>
                  <label for="first_name"> Product Details* </label>
                </div> 
                <div class="input-field col s12 ">
                <p> Image </p>
                  <input placeholder="Placeholder" id="first_name" type="file" class="validate" name='image'>
                ...
                <p class="padleft10">
                    <button  class="btn indigo " type="submit" name="action">Add</a>                 
                </p>
                <div class="row">
